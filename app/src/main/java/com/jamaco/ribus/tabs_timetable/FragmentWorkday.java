...
public class FragmentWorkday extends Fragment {
    ...
    private void showContent1() {
        ...
        data = helper.getWorkday1(num);

        message.setText(helper.getWorkday1Notice(num));
    ...
    private void showContent2() {
        ...
        data = helper.getWorkday2(num);

        message.setText(helper.getWorkday2Notice(num));
